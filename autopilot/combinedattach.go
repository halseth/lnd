...
func NewWeightedCombAttachment(h ...*WeightedHeuristic) (AttachmentHeuristic, error) {
...
// size.
//
// The scores is determined by quering the set of sub.heuristics, then combine
// these scores into a final score according to the active configuration.
// integers in the range in the range [0, M], where 0 indicates no improvement
// in connectivity if a channel is opened to this node, while M is the maximum
