...
type AgentConstraints interface {
	// AvailableChans should, given the passed parameters, and its internal
	// state, return whether more channels should be opened within the
	// channel graph. If the constraints allow us to open more channels,
	// then the first return value will represent the amount of additional
	// funds available towards creating channels. The second return value
	// is the exact *number* of additional channels that available.
	AvailableChans(chans []Channel, balance btcutil.Amount) (
...
// AvailableChans should, given the passed parameters, and its internal state,
// return whether more channels should be opened within the channel graph. If
// the constraints allow us to open more channels, then the first return value
// will represent the amount of additional funds available towards creating
// channels. The second return value is the exact *number* of additional
// channels that available.
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) AvailableChans(channels []Channel,
