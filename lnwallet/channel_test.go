...
func TestForceCloseDustOutput(t *testing.T) {
	...
	aliceChannel.channelState.OurChanCfg.ChanReserve = 0
	bobChannel.channelState.OurChanCfg.ChanReserve = 0
	aliceChannel.channelState.TheirChanCfg.ChanReserve = 0
	bobChannel.channelState.TheirChanCfg.ChanReserve = 0
...
func TestMaxAcceptedHTLCs(t *testing.T) {
	...
	aliceChannel.channelState.OurChanCfg.MaxAcceptedHtlcs = numHTLCs
	bobChannel.channelState.TheirChanCfg.MaxAcceptedHtlcs = numHTLCs
	...
	aliceChannel.channelState.TheirChanCfg.MaxAcceptedHtlcs = numHTLCsReceived
	bobChannel.channelState.OurChanCfg.MaxAcceptedHtlcs = numHTLCsReceived
...
func TestMaxPendingAmount(t *testing.T) {
	...
	// time.
	aliceChannel.channelState.OurChanCfg.MaxPendingAmount = maxPending
	bobChannel.channelState.TheirChanCfg.MaxPendingAmount = maxPending
...
func TestChanReserve(t *testing.T) {
	...
	setupChannels := func() (*LightningChannel, *LightningChannel, func()) {
		...
		aliceChannel.channelState.OurChanCfg.ChanReserve = aliceMinReserve

		// During channel opening Bob will also get to know Alice's
		// minimum reserve, and this will be found in his remote
		// config.
		bobChannel.channelState.TheirChanCfg.ChanReserve = aliceMinReserve
		...
		bobChannel.channelState.OurChanCfg.ChanReserve = bobMinReserve
		aliceChannel.channelState.TheirChanCfg.ChanReserve = bobMinReserve
...
func TestMinHTLC(t *testing.T) {
	...
	aliceChannel.channelState.OurChanCfg.MinHTLC = minValue
	bobChannel.channelState.TheirChanCfg.MinHTLC = minValue
