...
func (s *Switch) SendHTLC(firstHop lnwire.ShortChannelID, paymentID uint64,
	...
	// transaction. Without the mutex we would risk learning about a
	// preimage between checking the DB for an existing one  and forwarding
	// the payment.
...
func (s *Switch) handleLocalResponse(pkt *htlcPacket) {
	...
	// while we are adding the preimage to the DB and tearing down the
	// circuit.
